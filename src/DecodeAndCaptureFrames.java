...
public class DecodeAndCaptureFrames extends MediaListenerAdapter
{
    ...
    public static double SECONDS_BETWEEN_FRAMES = 5;

    public LinkedList<BufferedImage> getFrames(){
        return frames;
    }
    /**
    ...
    public static void main(String[] args)
    {
        ...
        new DecodeAndCaptureFrames(args[0],5);
    }
    ...
    public DecodeAndCaptureFrames(String filename,int timeDifference)
    {
        frames = new LinkedList<>();
        // create a media reader for processing video
        this.SECONDS_BETWEEN_FRAMES = timeDifference;
